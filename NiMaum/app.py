...
client = MongoClient('mongodb+srv://test:sparta@cluster0.ojspmhk.mongodb.net/Cluster0?retryWrites=true&w=majority',
                     tlsCAFile=certifi.where())
db = client.dbsparta_Nimaum
#
...
def api_register():
    ...
    db.user.insert_one({'id': id_receive, 'pw': pw_hash, 'nick': nickname_receive, 'coffee_count': 0, 'energy_count': 0,
